...
8. [`style-prompt-iteration`](style-prompt-iteration/SKILL.md)：Codex/ChatGPT 专用的纯美术风格提取/萃取/蒸馏/迭代；用户说 distill、extract、提取、萃取、反推风格时触发；按 `prompt_formula.md` 反推，至少迭代2轮，每轮必须生成脸部特写、人物全身、纯环境至少3张候选图，逐张对比并修订风格基底，三张都合格且已过第2轮才停止。
